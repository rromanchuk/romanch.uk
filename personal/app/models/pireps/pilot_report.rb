...
module Pireps
  ...
  class PilotReport
    ...
    local_secondary_index hash_key: :raw_text, range_key: :report_type, projected_attributes: :keys_only
    
    after_create :after_create_tasks

    def after_create_tasks
      Pireps::RawReport.create!(raw_text: raw_text, report_type: report_type, batch_file_id: batch_file_id, receipt_time: receipt_time)
    end
  end
end
