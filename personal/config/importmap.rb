...
pin 'firebase/messaging', to: 'https://www.gstatic.com/firebasejs/10.14.0/firebase-messaging.js'
# pin "firebase/auth", to: "https://www.gstatic.com/firebasejs/9.9.3/firebase-auth.js"
pin 'firebase/analytics', to: 'https://www.gstatic.com/firebasejs/10.14.0/firebase-analytics.js'
pin 'firebase/messaging/sw', to: 'https://www.gstatic.com/firebasejs/10.14.0/firebase-messaging-sw.js'
