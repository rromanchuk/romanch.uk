...
module RyanRomanchuk
  class PostsControllerTest < ActionDispatch::IntegrationTest
    ...
    setup do
      host! 'localhost'
      @post = ryan_romanchuk_posts(:one)
      Rails.application.config.action_dispatch.show_exceptions = true
    end
    
    test 'index' do
      unpublished = ryan_romanchuk_posts(:unpublished)
      get posts_url
    ...
    test 'show unpublished post to me' do
      sign_in_as ryan_romanchuk_users(:ryan)
      unpublished = ryan_romanchuk_posts(:unpublished)
    ...
    test 'should update post' do
      sign_in_as ryan_romanchuk_users(:ryan)
      patch post_path(@post), params: { ryan_romanchuk_post: { title: 'updated' } }
    ...
    test 'should not update post' do
      patch post_url(@post), params: { ryan_romanchuk_post: { title: 'updated' } }
