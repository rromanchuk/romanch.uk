...
module Tds
  class PirepsControllerTest < ActionDispatch::IntegrationTest
    setup do
      host! "personal.test"
      @pirep = tds_pireps(:ua)
      @urgent = tds_pireps(:uua)
    end
